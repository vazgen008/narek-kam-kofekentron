...
const friends: Friend[] = [
  { name: 'Armen', image: armenImage,videoUrl:'https://www.youtube.com/watch?v=Suqyb-QGkI0&list=RDSuqyb-QGkI0&start_radio=1'},
  ...
  { name: 'Dina', image: dinaImage,videoUrl:'https://www.youtube.com/watch?v=Suqyb-QGkI0&list=RDSuqyb-QGkI0&start_radio=1' },
